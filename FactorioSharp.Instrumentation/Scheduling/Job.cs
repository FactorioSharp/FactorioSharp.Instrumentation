...
abstract class Job
{
    ...
    /// </summary>
    public virtual Task OnConnectAsync(FactorioRconClient client, FactorioGameData data, FactorioMeterOptionsInternal options, CancellationToken cancellationToken) =>
        Task.CompletedTask;
    ...
    /// </summary>
    public virtual Task OnDisconnectAsync(FactorioGameData data, FactorioMeterOptionsInternal options, CancellationToken cancellationToken) => Task.CompletedTask;
