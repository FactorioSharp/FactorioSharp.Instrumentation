...
abstract class Job
{
    ...
    /// </summary>
    public virtual Task OnStartAsync(FactorioData data, FactorioMeasurementOptionsInternal options, CancellationToken cancellationToken) => Task.CompletedTask;
    ...
    /// </summary>
    public virtual Task OnConnectAsync(FactorioRconClient client, FactorioData data, FactorioMeasurementOptionsInternal options, CancellationToken cancellationToken) =>
        Task.CompletedTask;

    /// <summary>
    ///     Method called periodically when the application is connected to the factorio server
    /// </summary>
    public virtual Task OnTickAsync(FactorioRconClient client, FactorioData data, FactorioMeasurementOptionsInternal options, CancellationToken cancellationToken) =>
        Task.CompletedTask;
    ...
    /// </summary>
    public virtual Task OnDisconnectAsync(FactorioData data, FactorioMeasurementOptionsInternal options, CancellationToken cancellationToken) => Task.CompletedTask;
    ...
    /// </summary>
    public virtual Task OnStopAsync(FactorioData data, FactorioMeasurementOptionsInternal options, CancellationToken cancellationToken) => Task.CompletedTask;
